...
import { Lock, Shield, AlertTriangle, CheckCircle, Loader2, Clock, Globe, RefreshCw } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Analyze SSL/TLS security for any domain
          </p>
        </div>
          ...
          <Card className={`border-2 ${result.is_valid ? 'border-green-500/50 bg-green-500/5' : 'border-red-500/50 bg-red-500/5'}`}>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 rounded-lg bg-background/50">
                  <div className="text-lg font-bold">{result.issuer || 'Unknown'}</div>
