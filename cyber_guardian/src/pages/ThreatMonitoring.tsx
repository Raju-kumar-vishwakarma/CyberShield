...
const attackTypes = [
  { name: "SQL Injection", value: 35, color: "hsl(0, 100%, 50%)" },
  { name: "XSS Attacks", value: 25, color: "hsl(45, 100%, 50%)" },
  { name: "Brute Force", value: 20, color: "hsl(187, 100%, 42%)" },
  { name: "DDoS", value: 15, color: "hsl(155, 100%, 50%)" },
  { name: "Other", value: 5, color: "hsl(270, 100%, 60%)" },
];
